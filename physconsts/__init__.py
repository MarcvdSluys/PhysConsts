...
#   
#  This file is part of the PhysConsts Python package:
#  A Python package that provides physical constants.
#  See: https://github.com/MarcvdSluys/PhysConsts
#   
...
The PackageName package can be used under the conditions of the EUPL 1.2 licence.  These pages contain the API
documentation.  For more information on the Python package, licence and source code, see the
`PackageName GitHub page <https://github.com/MarcvdSluys/PackageName>`_.
"""
